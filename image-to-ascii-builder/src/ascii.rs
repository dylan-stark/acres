...
use crate::ImageToAsciiBuilderError;
...
/// Defines ASCII.
///
/// You can generate ASCII using a builder. Each option has a sensible default, so you only need to
/// set the ones you want to update. We also provide default and new for when it's convenient.
///
/// ```rust
/// # use anyhow::Result;
/// # use std::str::FromStr;
